...
/* harmony export */   "TonClient": () => /* reexport safe */ _ton_client_ts_core__WEBPACK_IMPORTED_MODULE_0__.TonClient
/* harmony export */ });
/* harmony import */ var _ton_client_ts_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(418);
/* harmony import */ var _ton_client_ts_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_ton_client_ts_core__WEBPACK_IMPORTED_MODULE_0__);
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }


var binaryLibraryFile;
...
switch (process.platform) {
  ...
  default:
    console.error("Unsupported platform '".concat(process.platform, "'!"));
...
try {
  library = __webpack_require__(116)("./".concat(binaryLibraryFile));
} catch (error) {
  ...
  var addonPath = path.resolve(__dirname, binaryLibraryFile);
  ...
  library = __webpack_require__(875)(addonPath);
}

_asyncToGenerator(function* () {
  _ton_client_ts_core__WEBPACK_IMPORTED_MODULE_0__.TonClient.loadBinaryLibrary(() => new Promise(res => res(library)));
})();
...
try {
  process.dlopen(module, __dirname + "/" + __webpack_require__.p + "tonclient-linux.node");
} catch (error) {
...
try {
  process.dlopen(module, __dirname + "/" + __webpack_require__.p + "tonclient-mac.node");
} catch (error) {
  throw new Error('node-loader:\n' + error);
}
...
try {
  process.dlopen(module, __dirname + "/" + __webpack_require__.p + "tonclient-win.node");
} catch (error) {
  throw new Error('node-loader:\n' + error);
}
...
var map = {
	...
	"./index.ts": 721,
	"./tonclient-linux": 499,
	"./tonclient-linux.node": 499,
	"./tonclient-mac": 174,
	"./tonclient-mac.node": 174,
	"./tonclient-win": 82,
	"./tonclient-win.node": 82
};
