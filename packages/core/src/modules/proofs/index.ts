...
export class ProofsModule {
   ...
   *
   * @param {ParamsOfProofBlockData} param - parameters
   */
  proof_block_data(params: ParamsOfProofBlockData): Promise<undefined> {
    return this.tonClient.request("proofs.proof_block_data", params);
  }
   ...
   *
   * @param {ParamsOfProofTransactionData} param - parameters
   */
  proof_transaction_data(
    params: ParamsOfProofTransactionData
  ): Promise<undefined> {
    return this.tonClient.request("proofs.proof_transaction_data", params);
  }
   ...
   * For more information about proofs checking, see description of `proof_block_data` function.
   *
   * @param {ParamsOfProofMessageData} param - parameters
   */
  proof_message_data(params: ParamsOfProofMessageData): Promise<undefined> {
    return this.tonClient.request("proofs.proof_message_data", params);
  }
}
